...
# purpose
instead of navigating and organizing informational 'widgets', a routinely generated email that targets specific API's and uses claude to summarize the information and email this summary on a predetermined basis (all the info. you need for the day sent in an email in the morning).

# stack
Python CRON via Github Actions
...
# setup
the following keys must be generated and added as github secrets...
  ...
  GOOGLE_REFRESH_TOKEN: collected via running the 'get_refresh_token.py' file initially
